<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="index.aspx.cs" Inherits="ASP_Assignment2.index" %>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Product Details<br />
            ...
            <br />
            <br />
            Product Quantity&nbsp; :&nbsp; <asp:TextBox ID="Product_Quantity" runat="server" TextMode="Number"></asp:TextBox>
            &nbsp;<asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ControlToValidate="Product_Quantity" Display="Dynamic" ErrorMessage="Product quantity required" ForeColor="#CC0000"></asp:RequiredFieldValidator>
&nbsp;<asp:RangeValidator ID="RangeValidator1" runat="server" ControlToValidate="Product_Quantity" Display="Dynamic" ErrorMessage="Quantity must be in between 100 and 1000" ForeColor="#CC0000" MaximumValue="1000" MinimumValue="100"></asp:RangeValidator>
            <br />
            <br />
            ...
            <br />
            &nbsp;<br />
            Received By&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; :&nbsp; <asp:DropDownList ID="Received_By" runat="server" Height="16px" Width="127px">
                <asp:ListItem>Deepak</asp:ListItem>
                <asp:ListItem>Raj</asp:ListItem>
                <asp:ListItem>Karan</asp:ListItem>
            </asp:DropDownList>
            <asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" ErrorMessage="Receiver name is required" ControlToValidate="Received_By" Display="Dynamic" ForeColor="#CC0000"></asp:RequiredFieldValidator>
            <br />
            <br />
            Receiver Email :&nbsp;&nbsp;&nbsp; :&nbsp;
            ...
            <br />
            IsInvoiced&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; :&nbsp;
            <asp:RequiredFieldValidator ID="RequiredFieldValidator8" runat="server" ErrorMessage="Please select invoive status" ControlToValidate="IsInvoiced" Display="Dynamic" ForeColor="#CC0000"></asp:RequiredFieldValidator>
