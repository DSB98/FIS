...
namespace WebApplicationPractice
{
    public partial class Home : System.Web.UI.Page
    {
        ...
        protected void logoutbtn_Click(object sender, EventArgs e)
        {
            ...
            // Request.Cookies["LoginCookie"].Expires = DateTime.Now.AddMinutes(-1);
            // Request.Cookies["loginCookie"].Expires = DateTime.Now.AddMinutes(-1);
            //Response.Cookies["LoginCookies"].Expires = DateTime.Now.AddMinutes(-1);
            //Response.Cookies["loginCookies"].Expires = DateTime.Now.AddMinutes(-1);

            //_ = Request.Cookies["LoginCookie"] == null;
